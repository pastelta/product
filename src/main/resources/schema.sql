...
VALUES ('111', '3', 'СМБ', '10', 'Депозит', '20', 'Договор');

-- product_class_code = value = 111, account_type = value = Клиентский
INSERT INTO tpp_ref_product_register_type ( value
                                           , account_type
                                           , register_type_name
                                           , product_class_code)
VALUES ('555111', 'Клиентский', 'Депозиты', '111');
